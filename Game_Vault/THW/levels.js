...
const DEATH_MESSAGES = [
    ...
    "Your own bullet says hi.",
    "The boss healed from that. Thanks.",
    "Did the screen just flip? Yes. Yes it did.",
    "Gravity is just a suggestion here.",
    "Left is right. Right is wrong.",
    "Can't see? That's the point.",
    "The boss was just pretending to die. LOL.",
    "You shot yourself. Technically.",
    "CHAOS REIGNS.",
    "That checkpoint was definitely real. Trust me.",
    "The hallway is getting creative.",
    "Your controls are mirrored. Enjoy.",
    "Everything is fine. This is fine.",
    "The game is playing YOU.",
    "Speed run? More like speed die.",
    "The darkness is your friend. Just kidding.",
    "Plot twist: the floor IS lava.",
    "Boss healed. You're welcome.",
    "Skill issue. (The game cheated.)",
];
